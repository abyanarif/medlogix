...
<div class="mb-8 flex items-center justify-between gap-4">
    <div>
        <h1 class="text-3xl font-black text-gray-950 dark:text-white flex items-center gap-2.5">
            <i class="fas fa-edit text-blue-600"></i> Edit Data Obat
        </h1>
        <p class="text-gray-500 dark:text-gray-400 text-xs mt-1">Perbarui parameter data obat, tingkat peringatan, stok fisik, atau harga satuan obat.</p>
    </div>
...
<div class="max-w-3xl bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 md:p-8 mx-auto">
    <h2 class="text-xl font-bold text-gray-950 dark:text-white mb-6 flex items-center gap-2">
        <i class="fas fa-prescription-bottle-medical text-blue-500"></i> Form Edit Parameter Obat
    </h2>
    ...
    <form method="POST" action="{{ route('medicines.update', $medicine->id) }}" class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div>
                ...
                <input 
                    ...
                    required
                    class="block w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm font-mono"
            ...
            <!-- Jumlah Stock -->
            <div>
                <label for="stok" class="block text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300 mb-1.5">Jumlah Stok</label>
                <input 
                    id="stok" 
                    type="number" 
                    name="stok" 
                    ...
                    required
                    min="0"
                    class="block w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm font-semibold text-blue-600 dark:text-blue-400"
                >
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <!-- Harga Obat -->
            <div>
                <label for="harga" class="block text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300 mb-1.5">Harga Satuan (Rupiah)</label>
                <input 
                    id="harga" 
                    type="number" 
                    name="harga" 
                    ...
                    required
                    min="0"
                    class="block w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm font-semibold"
                >
            </div>
            ...
            <div>
                ...
                <select 
                    ...
                    class="block w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm font-semibold"
                >
                    <option value="info" {{ old('alert_level', $medicine->alert_level) === 'info' ? 'selected' : '' }}>Info (Blue)</option>
        ...
        <div class="flex gap-4 pt-3">
            <button 
                type="submit"
                class="flex-grow bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl shadow-md hover:shadow-lg transition duration-200 text-sm flex items-center justify-center gap-1.5"
            >
